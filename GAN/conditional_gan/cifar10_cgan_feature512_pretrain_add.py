...
encoder_model = torch.load("/home/bike/2027/cifar_pretrain/pytorch-cifar/cifar10_vgg_true_49.model")
D_model = torch.load("/home/bike/2027/generative-models/GAN/conditional_gan/cifar10_fc_triplet_net_2017-05-11 18:14:56.149359/D_37500.model")
G_model = torch.load("/home/bike/2027/generative-models/GAN/conditional_gan/cifar10_fc_triplet_net_2017-05-11 18:14:56.149359/G_37500.model")
# G_model = torch.load("/home/bike/2027/generative-models/GAN/conditional_gan/cifar10_fc_triplet_net_2017-05-11 19:09:49.309872/G_5000.model")


# 24*24
enet = model.E_Net_VGG_cifar10().cuda()
...
# Evaluator: G
    ...
    if(epoch%check_points==0):
        ...
        owntool.save_color_picture_pixel(X.data.tolist(), out_dir + "recon_epoch{}_data_old.png".format(epoch ),column=column,image_size=32)
        owntool.save_color_picture_pixel(g_zero_output.data.tolist(), out_dir + "recon_epoch{}_zero.png".format(epoch),column=column,image_size=32)
        owntool.save_color_picture_pixel(g_fc_output1.data.tolist(), out_dir + "recon_epoch{}_real.png".format(epoch),column=column,image_size=32)
