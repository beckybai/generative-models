...
for it in range(100000):
    ...
    X, c = celebA.batch_next(mb_size,0, shuffle = True)
    X = Variable(X).cuda()
...
# Add Evaluator to the network as the condition information.
    ...
    if it % 500 == 0:
        ...
        owntool.save_color_picture_pixel(samples,output_path,image_size=64,column=8,mb_size = mb_size)
        owntool.save_color_picture_pixel(X.data.tolist(),output_path_real,image_size = 64,column=8,mb_size = mb_size)
