...
G = model.G_Net_FM_510(ngpu,add_in_feature,main_gpu=main_gpu).cuda()
...
# D PART ./ data_old/ d_f3 / error
    ...
    d_f3= Variable(torch.zeros([batch_size,feature_size,1,1])).cuda()
    d_f3 = d_f3.detach()
...
# G Part / data_g / g_f3 / dg_error
    ...
    g_f3 = Variable(torch.zeros([batch_size,feature_size,1,1])).cuda()
    g_f3 = g_f3.detach()
