...
G.load_state_dict(torch.load('./out_conv_part1/G_90000.model'))
D.apply(weights_init)
D.load_state_dict(torch.load('./out_conv_part1/D_90000.model'))
...
for it in range(100000):
    ...
    if it % 3000 == 0:
        ...
        for i in range(9): # change
            c[i*6:(i+1)*6] = i*np.ones(6)
