...
for it in range(30000):
    ...
    E_anch = E(torch.cat([X,c],1))
    E_loss_g_a = criterion(E_anch,ones_label)
    E_loss_g_r = criterion(E_real,ones_label)
    E_loss_g_f = criterion(E_fake,zeros_label)
    E_loss_g = E_loss_t_a + E_loss_t_r + E_loss_t_f
    E_loss_g.backward()
    G_solver.step()
