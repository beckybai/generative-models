...
out_dir = './out/cgan_d_fixed_{}'.format(datetime.now())
...
path = "/home/bike/2027/generative-models/GAN/conditional_gan/toys/out/cgan_label_right_2017-05-28_00:09:06.275851/"
...
for it in range(100000):
    ...
    if it % 200 == 0:
        ...
        ax.set(title='3 mode CGAN_df{}'.format(it))
        if(it%1000==0):
