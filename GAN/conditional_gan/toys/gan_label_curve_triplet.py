...
out_dir = './out/gan_label_curve_triplet_{}'.format(datetime.now())
...
for it in range(30000):
    ...
    if it % 1000 == 0:
        ...
        gs = gridspec.GridSpec(row_num, tot_pic_num//row_num, wspace=0.0, hspace=0.0)
