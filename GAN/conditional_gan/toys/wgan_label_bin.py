...
D = model.D_Net_w(X_dim + c_dim, 2, h_dim).cuda()
...
lr = 1e-1
G_solver = optim.SGD(G.parameters(), lr)
D_solver = optim.SGD(D.parameters(), lr)
...
for it in range(30000):
    ...
    if it % 200 == 0:
        ...
        print('Iter-{}; D_loss_real/fake: {}/{}; G_loss: {}'.format(it, D_loss.data.tolist(),
        ...
        #
        ax.set(aspect=1, title='4 mode. wgan lr=1e-4')
