...
celebA = data_convert.celebA_identity()
...
num = '0'
out_dir = './cifar100_result/identity_triplet_pretrain_{}_{}/'.format(datetime.now(),num)
out_dir.replace(" ","_")

if not os.path.exists(out_dir):
    os.makedirs(out_dir)
    shutil.copyfile(sys.argv[0], out_dir + '/identity.py')
...
G_model = torch.load("/home/bike/2027/generative-models/GAN/conditional_gan/cifar100_result/basic_2017-05-14 21:08:32.778985_0/G_90000.model")
D_model = torch.load("/home/bike/2027/generative-models/GAN/conditional_gan/cifar100_result/basic_2017-05-14 21:08:32.778985_0/D_90000.model")
...
d_num = 3
# avd_num = 1/d_num
G_solver = optim.Adam(G.parameters(), lr=4e-5)
D_solver = optim.Adam(D.parameters(), lr=4e-5)
